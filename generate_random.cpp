...
int main()
{
    ...
    */
    ...
    answer = "The output of the sequence of random generated numbers from 0 to the value of RAND_MAX" ; // 1. Write your answer to Q1 in between " "
    ...
    answer = "The output is the remainder of the random generated when divided by 5. Numbers between 0-4" ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "The remainder of the random generated when divided by 5 then add 3, Numbers between 0-7" ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "When you remove srand(time(null)), the program generates the same sequence of numbers twice because it doesnt randomize it the second time" ; // 4. Write your answer to Q4 in between " "
